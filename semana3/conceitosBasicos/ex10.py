...
favoriteTvShow = input('Qual a sua série preferida? \n')
animals = input('Qual o nome do seu animal de estimação? \n')

print(f'Oi {name}! Que legal que você mora em {city}, eu sou de São Leopoldo. Nunca assisti {favoriteTvShow}, mas irei por na minha watchlist :) Vi que você tem um animalzinho de estimação, qual o nome dele? {animals}? Que fofo!')
